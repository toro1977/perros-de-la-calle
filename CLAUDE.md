...
- **Última actividad real de código:** 2026-07-18 (ajustes finales de la tab bar). Antes de esta sesión, este archivo decía "recién creado, sin features" — quedó desactualizado; confiar en `git log`, no en este documento, si vuelve a pasar.
